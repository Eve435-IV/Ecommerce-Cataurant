...
import KoreanFood4 from "../../../../public/koreanfood4.jpeg"
    ...
    <>
      <div className={styles.mainbanner}> 
        ...
        <div className={styles.midbanner}>
          <Image className={styles.image}src={Koreanbanner} alt="Korean Food"/>
        ...
        <div className={styles.rightbanner}>
          {/* <Image className={styles.image}src={KoreanFood2} alt="Korean Food"/> */}
        </div>
      </div>
    </>
  );
