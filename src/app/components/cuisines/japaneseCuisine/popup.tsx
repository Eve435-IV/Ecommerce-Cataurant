...
import MisoSoup from "./public/miso.png";
import Edamame from "./public/edamame.png";
import Tempura from "./public/tempura.png";
            ...
            <Stack>
              <div className={styles.midcolumn}>
                ...
                <div className={styles.content}>
                  ...
                  <div className={styles.checkbox}>
                    <Checkbox />
                    <Image className={styles.logo} src={MisoSoup} alt="pickle" />
                    <div className={styles.smalltext}>Miso Soup</div>
                  </div>
                  <div className={styles.checkbox}>
                    <Checkbox />
                    <Image className={styles.logo} src={Edamame} alt="pickle" />
                    <div className={styles.smalltext}>Edamame</div>
                  </div>
                  <div className={styles.checkbox}>
                    <Checkbox />
                    <Image className={styles.logo} src={Tempura} alt="pickle" />
                    <div className={styles.smalltext}>Tempura</div>
                  </div>
                  <div className={styles.checkbox}>
                    <Checkbox />
